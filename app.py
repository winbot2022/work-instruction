...
PROCESS_TEMPLATES = {
    ...
    "日常点検": [
        "安全装置が正常に作動することを確認する",
        "非常停止ボタンが正常に作動することを確認する",
        "設備周辺に不要物・工具・材料が置かれていないことを確認する",
        "作動油量が適正範囲内であることを確認する",
        "潤滑油量が適正範囲内であることを確認する",
        "エア圧・油圧・水圧が指定範囲内であることを確認する",
        "油漏れ・水漏れ・エア漏れがないことを確認する",
        "異音・異臭・異常振動がないことを確認する",
        "回転部・摺動部に異常発熱がないことを確認する",
        "ベルト・チェーンにたるみ・損傷がないことを確認する",
        "配管・ホース・ケーブルに損傷や外れがないことを確認する",
        "治具・クランプ・位置決め部に緩みや破損がないことを確認する",
        "ワーク当たり面・基準面にキズ・異物がないことを確認する",
        "切粉・粉じん・異物が堆積していないことを確認する",
        "操作盤・表示灯・警報表示に異常がないことを確認する",
        "点検結果を記録し、異常があれば責任者へ報告する",
    ],
}
